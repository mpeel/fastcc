...
IF (option EQ 3) THEN BEGIN ; 2018 version (mostly the same as 2015)
 ...
 ENDIF ELSE BEGIN ; individual frequencies
   ...
   CASE freq OF
     ...
     'Q17': cc = [1.0125436391913436, -0.0047626476557725075, -0.0007290181381636897, 16.8]
     'Q19': cc = [1.0097515098746093, -0.0029060962669316278, -0.000945980118358522, 18.8]
     'Q17p': cc = [1.0269452929735823, -0.011160166272101483, -0.0011604058894213811, 16.8]
     'Q19p': cc = [1.005366057632537, 1.531136601255456e-05, -0.0012837681732906182, 18.8]
