...
def cc_calc():
	...
	plt.plot(alphas,mfi311_corrections,'-r',label='311')
	plt.plot(alphas,mfi313_corrections,'-.r',label='313')
	plt.plot(alphas,mfi311pol_corrections,'-b',label='311pol')
	plt.plot(alphas,mfi313pol_corrections,'-.b',label='313pol')
