...
def fastcc(freq, alpha=False, td=False, bd=False, detector=False, debug=False, option=3, returnfreq=False):
	...
	frequencies_v2 = {
		...
		'Q17': [0.9888926591458963, 0.006986281593109233, -0.0007107060258669477, 16.7], # UPDATE
		'Q19': [0.9886433438856964, 0.007541246196285672, -0.0009156379893644272, 18.7], # UPDATE 
		'Q17p': [1.0029823815141663, 0.0008640490621996672, -0.0012140291472187072, 16.7], # UPDATE
		'Q19p': [0.9843617866675408, 0.010330165097893152, -0.0012211561793953436, 18.7], # UPDATE
