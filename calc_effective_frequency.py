...
for spectra in specs:
	...
	print("P100: %.2f" % calc_freq(100.0,cc,spectra))
	cc = fastcc('P143',spectra,option=1)
	print("P143: %.2f" % calc_freq(143.0,cc,spectra))
	cc = fastcc('P217',spectra,option=1)
	print("P217: %.2f" % calc_freq(217.0,cc,spectra))
	cc = fastcc('P353',spectra,option=1)
	print("P353: %.2f" % calc_freq(353.0,cc,spectra))
	cc = fastcc('P545',spectra,option=1)
	print("P545: %.2f" % calc_freq(545.0,cc,spectra))
	cc = fastcc('P857',spectra,option=1)
	print("P857: %.2f" % calc_freq(857.0,cc,spectra))
